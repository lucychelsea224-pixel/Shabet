...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    ...
    // Once a newly-deployed service worker activates and takes control,
    // a tab that was already open is still running on the OLD worker's
    // in-memory state until it reloads once. Do that reload automatically
    // instead of leaving the admin to refresh repeatedly hoping it "takes".
