    ...
    <div class="login-wrap">
      <div class="login-inner">
        ...
        <form class="login-card" id="signup-form">
          ...
          <div>
            <label class="field-label">Password</label>
            <input type="password" required minlength="6" id="signup-password" class="text-input tap-target" placeholder="At least 6 characters" />
          </div>
          <div>
            <label class="field-label">Confirm Password</label>
            <input type="password" required id="signup-password-confirm" class="text-input tap-target" placeholder="••••••••" />
          </div>
