import { store, subscribe, setDraftSlip, clearDraftSlip, bookTicket, submitCustomerTicket, scorersForFixture, computeStandings } from './store.js';
...
function handleBook(root, btn) {
  ...
  if (isCustomer()) {
    ...
    const ticket = submitCustomerTicket(user, selections, stakeNum);
    clearDraftSlip();
    ui.sheetOpen = false;
    ui.submitted = ticket;
    render(root);
