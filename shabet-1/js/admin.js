...
function migrateHtml() {
  ...
  return `
    ...
    <p class="admin-subtext">
      ...
      Import match results first, then tickets — importing a result re-settles every ticket tied to
      that match, so doing it after tickets are already imported could reset an Anytime Scorer or
      Custom Market leg that was already correctly won.
    </p>
    ...
    <div class="settings-card">
      <h3 style="margin:0 0 8px;font-size:15px;color:var(--pitch-800);">Step 2 — Booked Tickets</h3>
