    ...
    ${pendingCount > 0 ? `
      <div class="settings-card" style="border:1px solid #f59e0b;background:#fffbeb;">
        <h3 style="margin:0 0 6px;font-size:15px;color:#92400e;">
          ${pendingCount} settlement${pendingCount === 1 ? '' : 's'} saved on this device, not yet synced
        </h3>
        <p class="admin-subtext" style="margin:0 0 10px;">
          The connection dropped when these were submitted. They're already showing correctly here
